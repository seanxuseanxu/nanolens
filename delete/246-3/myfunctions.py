...
def readJson(path):
    ...
    for ii in priordict[1]:
        if ii["name"] == "SERSIC":
            ...
            lens_light_model_Backward.append(shapelets.Shapelets(shapelet_n_max, interpolate=False, use_lstsq=True))
        ...
        if ii["name"] == "SERSIC":
            ...
            lens_light_model_Forward.append(shapelets.Shapelets(shapelet_n_max, interpolate=False, use_lstsq=False))
    ...
    for ii in priordict[2]:
        ...
        if ii["name"] == "SERSIC":
            ...
            source_light_model_Backward.append(shapelets.Shapelets(shapelet_n_max, interpolate=False, use_lstsq=True))
        ...
        if ii["name"] == "SERSIC":
            ...
            source_light_model_Forward.append(shapelets.Shapelets(shapelet_n_max, interpolate=False, use_lstsq=False))
